...
Команда для предложения изменений / запрос на вливание изменений в рейпозиторий

    pull request

В больших компаниях один ответственный за проект создает аккаунт. Другие пользователи дают команду pull request. При этоим Предлагать изменения на GitHub принято в отдельной ветке.
