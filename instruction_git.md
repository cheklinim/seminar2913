...
### Pull request - отправка изменений на проверку или приемку

1. Вводим команду git push
2. В окне Github нажимаем кнопку compare & pull request
3. Можем ввести комментарий
