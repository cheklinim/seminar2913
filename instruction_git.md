...
где вместо <имя файла> вводится путь к файлу относительно расположения репозитория. Для быстрого ввода можно использовать первые буквы репозитория + TAB.
...
## Fork репозитория
Для форка чьего ли-бо общедоступного репозитория нам необходимо в GitHub найти нужную нам работу и использовать для копирования кнопку fork

![Пример из GitHub](1.png)

Далее выбрать название для него и он добавится в ваш репозиторий как копия, после чего можно успешно продолжать работу.