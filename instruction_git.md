...
Чтобы поучаствовать в работе над общим проектом,сначала надо сделать копию этого репозитория, находясь в своем аккаунте на GitHub. Для этого используется кнопка **Fork**. 

Скопировав ссылку на этот репозиторий можно продолжить работу уже в своем локальном репозитории при помощи следующей команды:

    git clone <ссылка>

В чистой папке в локальном репозитории переходим в клонированный репозиторий при помощи команды:

    cd <имя репозитория>

После проведения работы над общим проектом и внесения всех изменений отправляем данные в свой удаленный репозиторий командой ** git push**.

А затем делаем запрос **pull request**  на вливание наших данных в *чужой* репозиторий.
